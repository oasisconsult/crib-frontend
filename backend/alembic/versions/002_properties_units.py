...
def upgrade() -> None:
    ...
    op.create_table(
        ...
        sa.Column("type",
                  sa.Enum("flat", "house", "hostel", "commercial", "villa",
                          name="property_type_enum", create_type=False), nullable=False),
        sa.Column("status",
                  sa.Enum("active", "inactive", "maintenance",
    ...
    op.create_table(
        ...
        sa.Column("type",
                  sa.Enum("single", "double", "studio", "ensuite", "shared",
                          name="unit_type_enum", create_type=False), nullable=False),
        sa.Column("status",
                  sa.Enum("available", "occupied", "reserved", "maintenance",
