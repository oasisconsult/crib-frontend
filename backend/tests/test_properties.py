...
@pytest.mark.asyncio
async def test_get_unit_as_superadmin(client: AsyncClient, prop, unit):
    """Superadmin has cross-org access — org_id=None must not be matched literally
    against Property.organisation_id (NULL == NULL is never true in SQL)."""
