...
export function OnboardingWizard({
  ...
  const resubmitBanner = isResubmit && !isApproved && (
    <div className="rounded-[6px] border border-amber-200 bg-amber-50 dark:border-amber-200 dark:bg-amber-100/40 px-4 py-3 text-sm text-amber-800 dark:text-amber-200">
            ...
            <Card>
              ...
              <CardContent className="space-y-4">
                {uploadedDocs.length > 0 && (
                  <div className="rounded-[5px] border border-primary/15 bg-primary/5 px-3 py-2 space-y-1">
            ...
            <div className="max-w-2xl mx-auto space-y-6">
              ...
              {paymentStep === "payment" &&
                (preview ? (
                  ...
                  <div className="rounded-[6px] border border-destructive/30 bg-destructive/5 p-6 text-center space-y-3">
