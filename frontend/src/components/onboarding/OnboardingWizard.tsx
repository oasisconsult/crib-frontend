    ...
    submit(
      {
        ...
        data: {
          ...profileValues,
          documents: uploadedDocs.map((url, i) => ({
            id: `doc-${i}`,
            tenantId: tenant.id,
            type: "other" as const,
            name: `Document ${i + 1}`,
            ...
            <CardContent>
              <form onSubmit={handleProfileNext} className="space-y-4">
                ...
                <div className="space-y-1.5">
                  ...
                  <Input id="phone" type="tel" placeholder="+44 7700 900000" error={!!form.formState.errors.phone} {...form.register("phone")} />
                </div>
                <div className="grid grid-cols-2 gap-3">
                  <div className="space-y-1.5">
                  ...
                  <div className="space-y-1.5">
                    ...
                    <Input id="nationality" placeholder="British" {...form.register("nationality")} />
                  </div>
                </div>
          ...
          <Card>
            ...
            <CardContent className="space-y-4">
              <FileUpload
                ...
                tenantId={tenant.id}
                maxFiles={5}
                onUpload={(urls) => setUploadedDocs((prev) => [...prev, ...urls])}
              />
              {uploadedDocs.length > 0 && (
                <p className="text-sm text-emerald-600">{uploadedDocs.length} file{uploadedDocs.length !== 1 ? "s" : ""} uploaded</p>
              )}
