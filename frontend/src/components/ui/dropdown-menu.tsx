...
>(({ className, ...props }, ref) => (
  <DropdownMenuPrimitive.SubContent
    ref={ref}
    className={cn(
      "z-50 min-w-[8rem] overflow-hidden rounded-xl border bg-white dark:bg-[#111827] p-1 text-popover-foreground shadow-lg",
  ...
  <DropdownMenuPrimitive.Portal>
    <DropdownMenuPrimitive.Content
      ...
      className={cn(
        ...
        "rounded-[10px] border border-[#E2E8F0] bg-white p-1",
...
>(({ className, inset, ...props }, ref) => (
  <DropdownMenuPrimitive.Item
    ref={ref}
    className={cn(
      "relative flex cursor-default select-none items-center gap-2 rounded-[7px] px-2.5 py-1.5 text-[13px] text-[#0F172A] outline-none transition-colors focus:bg-[#F1F5F9] data-[disabled]:pointer-events-none data-[disabled]:opacity-40 [&>svg]:size-3.5 [&>svg]:shrink-0 [&>svg]:text-[#64748B]",
      inset && "pl-8",
      className,
    )}
    {...props}
...
>(({ className, inset, ...props }, ref) => (
  <DropdownMenuPrimitive.Label
    ref={ref}
    className={cn("px-2.5 py-2 text-[11px] font-semibold uppercase tracking-wider text-[#94A3B8]", inset && "pl-8", className)}
    {...props}
  />
));
