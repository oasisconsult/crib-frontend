        ...
        <div className="flex flex-wrap gap-1.5">
          {TEMPLATE_VARIABLES.map((v) => (
            <button
              ...
              className="text-xs px-2 py-0.5 rounded-[5px] bg-teal-50 text-teal-700 hover:bg-teal-100 dark:bg-teal-100/40 dark:text-teal-300 border border-teal-200 dark:border-teal-200 font-mono transition-colors"
            >
              {`{{${v}}}`}
            </button>
          ))}
