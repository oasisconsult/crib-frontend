...
export function WalletBalanceCard({ tenantId }: WalletBalanceCardProps) {
  ...
  return (
    <Card className="border-emerald-200 bg-emerald-50 dark:border-emerald-200 dark:bg-emerald-100/40">
      <CardContent className="p-4 flex items-center gap-4">
        <div className="flex h-10 w-10 shrink-0 items-center justify-center rounded-full bg-emerald-100 dark:bg-emerald-100/40">
        ...
        <div className="flex-1 min-w-0">
          ...
          <p className="text-xs text-emerald-600/80 dark:text-emerald-400/80 mt-0.5">
            Overpayment credit — will be applied to your next rent
            automatically.
          </p>
        </div>
      </CardContent>
