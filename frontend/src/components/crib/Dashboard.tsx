...
const ACTIVITY_ICON_CLASSES: Record<
  ActivityType,
...
> = {
  ...
  tenant: {
    bg: "bg-emerald-50 dark:bg-emerald-100/40",
    text: "text-emerald-700 dark:text-emerald-300",
    icon: <Users className="h-3.5 w-3.5" />,
  },
  alert: {
    bg: "bg-red-50 dark:bg-red-100/40",
...
> = {
  ...
  pending: {
    label: "Pending",
    className:
      "bg-amber-50 text-amber-800 dark:bg-amber-100/40 dark:text-amber-300",
  },
  overdue: {
    label: "Overdue",
    className: "bg-red-50 text-red-800 dark:bg-red-100/40 dark:text-red-300",
  },
};
...
function ActivityRow({ item }: { item: Activity }) {
  ...
  return (
    <div className="flex items-start gap-3 py-3 border-b border-border/60 last:border-0">
      ...
      <span
        className={cn(
          "text-[11px] font-semibold rounded-[4px] px-2 py-0.5 shrink-0",
          status.className,
        )}
      >
        {status.label}
...
function QuickAction({
  ...
  return (
    ...
    >
      <div
        className={cn(
          "h-8 w-8 rounded-[7px] flex items-center justify-center shrink-0",
          bgClass,
          iconClass,
        )}
        aria-hidden="true"
  ...
  const activities: Activity[] = [
    {
      id: "1",
      type: "payment",
      description: "John Doe paid rent — Sunset Apartments, Jan 2026",
      time: "2 hours ago",
      status: "completed",
    },
    {
      id: "2",
      type: "maintenance",
      description: "Leaking tap reported — Building A, Unit 4B",
      time: "4 hours ago",
      status: "pending",
    },
    {
      id: "3",
      type: "tenant",
      description: "Sarah Kato onboarded — Oak Street Property",
    ...
    },
    {
      id: "4",
      type: "alert",
      description: "Riverside Complex — 3 units rent overdue",
      time: "2 days ago",
      status: "overdue",
    },
    {
      id: "5",
      type: "payment",
      description: "Deposit received — Nakasero Heights, Unit 2A",
      time: "2 days ago",
      status: "completed",
    },
  ];
      ...
      <div className="grid grid-cols-1 lg:grid-cols-5 gap-4">
        ...
        >
          <div className="flex items-center justify-between px-5 py-3.5 border-b border-border">
            <div>
              <h2
                id="dash-properties-heading"
                className="text-[13.5px] font-semibold text-foreground tracking-[-0.01em]"
              >
                Properties
              </h2>
              <p className="text-[11px] text-muted-foreground mt-0.5">
