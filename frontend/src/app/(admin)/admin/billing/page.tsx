...
const PLAN_FEATURES: { key: string; label: string }[] = [
  ...
  { key: "esignature_enabled",    label: "E-Signatures"           },
  { key: "onboarding_enabled",    label: "Tenant Onboarding"      },
  { key: "screenings",            label: "Tenant Screening"       },
  { key: "efris",                 label: "EFRIS Tax Receipts"     },
