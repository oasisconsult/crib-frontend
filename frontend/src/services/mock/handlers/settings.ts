...
const DEFAULTS: SystemSetting[] = [
  ...
  { key: "features.onboarding_enabled", value: "true",    category: "features", label: "Tenant Onboarding",        description: "Enable the self-service onboarding wizard.",                                        valueType: "boolean", isSecret: false, isRequired: true,  updatedBy: null, updatedAt: "2026-01-01T00:00:00Z", createdAt: "2026-01-01T00:00:00Z" },
];
...
function grouped(): SettingsByCategory {
  const g: SettingsByCategory = { storage: [], email: [], sms: [], whatsapp: [], platform: [], features: [] };
  store.forEach((s) => {
