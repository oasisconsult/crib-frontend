...
export const DEFAULT_RULE_SCHEMA: RuleSchema = {
  ...
  fields: [
    ...
    },
    {
      ...
      min: 0,
      required: true,
      description: "Amount or percentage depending on fee type. Set to 0 to disable late fees.",
    },
    {
    ...
    },
    {
      ...
      max: 6,
      required: true,
      description: "Months of rent paid upfront at lease start. Set to 0 if not required.",
    },
    {
